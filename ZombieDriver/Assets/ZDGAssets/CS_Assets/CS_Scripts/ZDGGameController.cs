...
//CALCULATING SPAWN CHANCES
        ...
        IEnumerator GameOver(float delay)
		{
            ...
            if ( gameOverCanvas )    
			{
				...
				gameOverCanvas.Find("Base/TextScore").GetComponent<TMP_Text>().text = "分数： " + score.ToString();
				...
				gameOverCanvas.Find("Base/TextHighScore").GetComponent<TMP_Text>().text = "最高分 " + highScore.ToString();
